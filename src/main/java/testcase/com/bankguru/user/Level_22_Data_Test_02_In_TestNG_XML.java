...
public class Level_22_Data_Test_02_In_TestNG_XML extends AbstractTest {
    WebDriver driver;
    ...
    @Parameters("email")
    @Test
    public void TC_01_Register_To_System(String emailAddress) {
        emailAddress = emailAddress + randomNumber() + "@trump.org";
    ...
    @Parameters({"fullName" , "street" , "phone", "city"})
    @Test
    public void TC_03_New_Customer(String fullName, String street, String phone, String city) throws InterruptedException {
